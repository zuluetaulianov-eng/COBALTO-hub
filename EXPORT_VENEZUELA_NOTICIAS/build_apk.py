"""
build_apk.py — Script de automatización para empaquetar Venezuela Noticias en un archivo APK Nativo de Android (.apk)

Soporta compilación TWA (Trusted Web Activity via Bubblewrap / Google Official) -> APK nativo ultraligero (~2MB) con Service Worker PWA.
"""
...
def generate_twa_manifest(app_url: str, app_name: str = "Venezuela Noticias", package_id: str = "com.venezuelanoticias.app"):
    ...
    manifest_data = {
        ...
        "appVersionCode": 1,
        "shortcuts": [],
        "generatorApp": "Venezuela-Noticias-APK-Builder"
    }
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Compilar APK Nativo de Android para Venezuela Noticias")
