...
PROBLEM_FEEDS = {
    ...
    "CNN en Español": {
        "reason": "Feed RSS de CNN (edition_americas.rss) desactualizado y sin timestamps en las entradas",
        "since": "2026-08",
        "status": "inactivo",
        "notes": "Reemplazado por DW Español para evitar noticias estáticas sin fecha",
    },
    "El Carabobeño": {
