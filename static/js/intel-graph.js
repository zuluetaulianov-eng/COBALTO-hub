...
function showGraphNodeDetail(nodeId) {
    ...
    panel.innerHTML = '<div class="gdetail-header" style="border-left:4px solid ' + catColor + ';">' +
        ...
        '<button onclick="if(window.OsirisRecon){switchTab(\'tab-osiris-recon\');window.OsirisRecon.switchSubTab(\'ivss\');window.OsirisRecon.runTool(\'ivss\', \'\');}" style="background:rgba(0,229,255,0.12);border:1px solid rgba(0,229,255,0.4);border-radius:4px;color:#00E5FF;padding:6px;font-size:10px;font-family:monospace;cursor:pointer;text-align:left;">🏛️ IVSS INSTITUCIONAL (Pensiones & Salud)</button>' +
        '<button onclick="if(window.OsirisRecon){switchTab(\'tab-osiris-recon\');window.OsirisRecon.switchSubTab(\'seniat\');window.OsirisRecon.runTool(\'seniat\', \'' + entityId.replace(/'/g, "\\'") + '\');}" style="background:rgba(255,215,0,0.12);border:1px solid rgba(255,215,0,0.4);border-radius:4px;color:#FFD700;padding:6px;font-size:10px;font-family:monospace;cursor:pointer;text-align:left;">📜 CONSULTAR SENIAT (RIF/INSTITUCIONAL)</button>' +
        '<button onclick="if(window.OsirisRecon){switchTab(\'tab-osiris-recon\');window.OsirisRecon.switchSubTab(\'saime\');window.OsirisRecon.runTool(\'saime\', \'\');}" style="background:rgba(255,64,129,0.12);border:1px solid rgba(255,64,129,0.4);border-radius:4px;color:#FF4081;padding:6px;font-size:10px;font-family:monospace;cursor:pointer;text-align:left;">🛂 SAIME INSTITUCIONAL (Comunicados & Movilidad)</button>' +
        '<button onclick="if(window.OsirisRecon){switchTab(\'tab-osiris-recon\');window.OsirisRecon.switchSubTab(\'cne\');window.OsirisRecon.runTool(\'cne\', \'\');}" style="background:rgba(118,255,3,0.12);border:1px solid rgba(118,255,3,0.4);border-radius:4px;color:#76FF03;padding:6px;font-size:10px;font-family:monospace;cursor:pointer;text-align:left;">🗳️ CNE INSTITUCIONAL (Comunicados & Avisos)</button>' +
        '</div></div>' +
