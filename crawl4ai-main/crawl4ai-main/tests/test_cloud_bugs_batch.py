...
from crawl4ai.antibot_detector import _looks_like_data, is_blocked
from crawl4ai.async_configs import ALLOWED_DESERIALIZE_TYPES, from_serializable_dict, to_serializable_dict
...
try:
    from crawl4ai import CacheMode, CrawlerRunConfig, DefaultMarkdownGenerator, LXMLWebScrapingStrategy, RegexChunking
