...
def test_llm_job_payload_model():
    ...
    try:
        ...
        print("✅ LlmJobPayload accepts webhook_config")
        ...
        print("✅ LlmJobPayload works without webhook_config (optional)")
...
def test_handle_llm_request_signature():
    ...
    try:
        ...
        if 'webhook_config' in params:
            print("✅ handle_llm_request has webhook_config parameter")
            ...
            print("❌ handle_llm_request missing webhook_config parameter")
            return False
...
def test_process_llm_extraction_signature():
    ...
    try:
        ...
        if 'webhook_config' in params:
            print("✅ process_llm_extraction has webhook_config parameter")
            ...
            print("❌ process_llm_extraction missing webhook_config parameter")
            return False
...
def test_webhook_integration_in_api():
    ...
    try:
        ...
        if llm_notification_count >= 3:
            print("✅ Sufficient notification points (success + failure paths)")
        else:
