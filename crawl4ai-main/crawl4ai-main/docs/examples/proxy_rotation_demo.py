...
from crawl4ai import AsyncWebCrawler, BrowserConfig, CacheMode, CrawlerRunConfig, RoundRobinProxyStrategy
...
if __name__ == "__main__":
    ...
    from crawl4ai import CrawlerMonitor, DefaultMarkdownGenerator, DisplayMode, MemoryAdaptiveDispatcher
